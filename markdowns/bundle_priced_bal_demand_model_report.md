...
Expressed per unit of metered EIP-7999 gas rather than per historical unit, the intensities become $w_{\mathrm{execution}}/m_{\mathrm{execution}}=0.049$ and $w_{\mathrm{state}}/m_{\mathrm{state}}=0.0074$ at $\lambda=0$. Each unit of metered execution gas produces approximately 0.049 units of BAL data gas, and each unit of metered state gas approximately 0.0074.
...
| $m_{\mathrm{execution}}$ | 1.447956 | — | EIP-8038 and EIP-2780 execution repricing |
...
| $w_{\mathrm{execution}}/m_{\mathrm{execution}}$ | 0.049050 | Data gas per unit of metered execution gas |
